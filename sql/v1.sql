...
INSERT INTO `categoria` (`id`,`parent_id`,`name`,`page`,`status`,`sort_order`) VALUES 
 ...
 (4,0,'Transparência','transparencia.php',1,3),
 (5,0,'Classificados','classificados-visualizar.php',1,4),
...
CREATE TABLE `fi_despesa` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='financeiro - despesas';
...
INSERT INTO `fi_despesa` (`id`,`mes_ano_referencia`,`descricao`,`data_despesa`,`valor_despesa`) VALUES 
 (1,'2022-12-01 00:00:00','Pagamento Ronda','2022-12-10 00:00:00',5167.00);
...
CREATE TABLE `fi_receita` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=31 DEFAULT CHARSET=latin1 COMMENT='financeiro - receita';
...
INSERT INTO `fi_receita` (`id`,`id_lote`,`mes_ano_referencia`,`data_receita`,`valor_receita`) VALUES 
 ...
 (6,209,'2022-12-01 00:00:00','2022-12-02 00:00:00',150.00),
...
INSERT INTO `noticia` (`id`,`titulo`,`conteudo`,`data_noticia`,`url_foto_noticia`) VALUES 
 (1,'Chuvas castigam o bairro pra caralho mano c nao tem noção do tanto de agua q ta vindo, parece q estamos em outro pais vleho nepossiver isso nao cara!','As constantes chuvas estão fudendo todas as ruas do bairro!','2022-12-12 21:34:00','img/noticias/n1.jpeg');
